...
const slides = [
  {
    ...
    content: (
      <div className="space-y-4 text-slate-300 text-sm leading-relaxed">
        <p>
          <strong className="text-white">WasteLess AI</strong> is an applied data science and artificial intelligence system designed to quantify, model, and mitigate global food wastage across agricultural and retail supply chains.
        </p>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4 text-slate-300 text-sm leading-relaxed">
        <p>
          The system operates exclusively on the verified <code className="text-emerald-400 bg-slate-950 px-2 py-0.5 rounded-lg border border-slate-800">global_food_wastage_dataset.csv</code>, comprising:
        </p>
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs">
          <div className="p-3.5 rounded-2xl bg-slate-950/80 border border-slate-800 text-center">
            <span className="font-black text-white text-base block font-mono">5,000</span>
            <span className="text-slate-400">Total Observations</span>
          </div>
          <div className="p-3.5 rounded-2xl bg-slate-950/80 border border-slate-800 text-center">
            <span className="font-black text-emerald-400 text-base block font-mono">0</span>
            <span className="text-slate-400">Missing Values</span>
          </div>
          <div className="p-3.5 rounded-2xl bg-slate-950/80 border border-slate-800 text-center">
            <span className="font-black text-white text-base block font-mono">20</span>
            <span className="text-slate-400">Sovereign Nations</span>
          </div>
          <div className="p-3.5 rounded-2xl bg-slate-950/80 border border-slate-800 text-center">
            <span className="font-black text-white text-base block font-mono">8</span>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4 text-slate-300 text-sm leading-relaxed">
        ...
        <div className="p-4 rounded-2xl bg-slate-950/80 border border-emerald-500/30 space-y-2 text-xs font-mono">
          ...
          <div className="text-emerald-300 font-bold">• R² Score: 0.9504 (95.04% of variance explained)</div>
          ...
          <div className="text-emerald-400 font-black">• Error Reduction vs Baseline: +80.5%</div>
        </div>
        <p className="text-xs text-slate-400">
    ...
    content: (
      <div className="space-y-4 text-slate-300 text-sm leading-relaxed">
        ...
        <ul className="text-xs text-slate-300 space-y-2.5 list-disc list-inside">
          <li>
            <strong className="text-white">Offline Training:</strong> Python pipeline (<code className="text-emerald-400 font-mono">scripts/train_model.py</code>) trains models via scikit-learn and exports exact weights and validation metrics to JSON.
          </li>
          <li>
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-slate-900/80 border border-emerald-500/20 rounded-3xl p-6 sm:p-7 shadow-card backdrop-blur-xl space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-5 border-b border-slate-800">
          <div>
            <span className="text-xs font-bold text-emerald-400 flex items-center gap-1.5 uppercase tracking-wider">
              <GraduationCap className="w-4 h-4" /> Academic Defense Slide Deck
            </span>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="p-2 rounded-xl bg-slate-950 border border-slate-800 text-slate-300 hover:text-white disabled:opacity-30 disabled:cursor-not-allowed transition-all"
            >
        ...
        {/* Slide Body */}
        <div className="min-h-[220px] p-5 rounded-2xl bg-slate-950/70 border border-slate-800/80">
          ...
          {slides.map((s, idx) => (
            <button
              ...
              className={`h-2 rounded-full transition-all ${
                activeSlide === idx
                  ? 'w-8 bg-emerald-400 shadow-glow'
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-slate-900/80 border border-emerald-500/20 rounded-3xl p-6 shadow-card backdrop-blur-xl space-y-4">
        ...
        <div className="bg-slate-900/80 border border-slate-800 rounded-3xl p-6 shadow-card backdrop-blur-xl space-y-4 flex flex-col justify-between">
          <div className="space-y-3">
            ...
            <p className="text-xs text-slate-400 leading-relaxed">
              This application is prepared as an academic research and technical demonstration project. All statistical metrics (MAE, RMSE, R²) and correlations were directly computed from the 5,000 observations in <code className="text-emerald-300 bg-slate-950 px-1.5 py-0.5 rounded font-mono">global_food_wastage_dataset.csv</code>.
            </p>
            <p className="text-xs text-slate-400 leading-relaxed">
